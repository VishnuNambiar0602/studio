...
export function AdminForgotPasswordDialog() {
  ...
  const handleEmailSubmit = async (values: z.infer<typeof emailSchema>) => {
    setLoading(true);
    // Ensure we're checking for an admin user
    const result = await sendPasswordResetCode(values.email, true);
  ...
  return (
    <>
      ...
      <AlertDialog open={showCodeAlert} onOpenChange={setShowCodeAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Admin Account Recovery (Simulation)</AlertDialogTitle>
