...
export function ProductFilters({ availableVendors, filters, onFilterChange }: ProductFiltersProps) {
    ...
    <div className="p-6 bg-card rounded-lg border shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
            ...
            <div className="space-y-2">
                ...
                <Select
                    value={filters.sort}
                    onValueChange={(value) => handleFilterChange('sort', value as Filters['sort'])}
                >
