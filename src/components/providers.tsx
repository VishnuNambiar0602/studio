...
function SettingsApplier({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        // Handle theme and color scheme
        const root = document.documentElement;
        
        if (theme === 'dark') {
            html.classList.add('dark');
            // When in dark mode, clear any inline styles to let CSS variables from .dark rule apply
            ...
            // When in light mode, apply the custom color scheme
            if (colorScheme) {
    ...
    }, [language, fontSize, theme, colorScheme]);
